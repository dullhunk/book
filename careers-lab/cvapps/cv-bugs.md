...
* **CHECK IT** Have another look at the [CV and LinkedIn guide](https://github.com/dullhunk/book/blob/master/careers-lab/startingpoints/CVlinkedinguide.pdf) from the careers service, there is good advice mentioned there that is not in this guide
