...
* **CHECK IT** Have another look at the CV and LinkedIn guide from the careers service [man.ac.uk/6Ef90a](http://man.ac.uk/6Ef90a) there is good advice mentioned there that is not in this guide
* **UPLOAD IT** Upload an updated version to the CV bank once you've changed it [studentnet.cs.manchester.ac.uk/employment/industryclub/cvbank](https://studentnet.cs.manchester.ac.uk/employment/industryclub/cvbank)
