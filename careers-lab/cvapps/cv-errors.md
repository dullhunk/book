...
It is really important to get the formatting of your CV right so that it looks professional.
  ...
  8. **PRINT** Print out your CV to check what it actually looks like. Can you read it? Odd things can happen that make your CV look rubbish, so it is worth trying out a few different printers. Does it fit nicely onto two pages? Without any nasty page and line breaks that create widowed & orphaned text? If you're using a fancy font, it might not work on all devices and printers. You might need to investigate [embedding the fonts in the pdf](https://www.google.co.uk/search?q=embed+fonts+pdf) to prevent any [https://en.wikipedia.org/wiki/Font_substitution](font substition) ruining your hard work.
...
Good luck with your applications and interviews. If you need any help contact Mabel, the careers service or mysefl. I'm happy to give more feedback on improved versions of your CV in the future.
